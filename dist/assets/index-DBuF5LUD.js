...
`;class w2 extends Ct{constructor(e={}){super(),this.material=new hi({vertexShader:b2,fragmentShader:A2,uniforms:{uTime:{value:0},uOpacity:{value:.8},uEnvironmentMap:{value:e.environmentMap},uWavesAmplitude:{value:.025},uWavesFrequency:{value:1.07},uWavesPersistence:{value:.3},uWavesLacunarity:{value:2.18},uWavesIterations:{value:8},uWavesSpeed:{value:.4},uTroughColor:{value:new qe("#186691")},uSurfaceColor:{value:new qe("#9bd8c0")},uPeakColor:{value:new qe("#bbd8e0")},uPeakThreshold:{value:.08},uPeakTransition:{value:.05},uTroughThreshold:{value:-.01},uTroughTransition:{value:.15},uFresnelScale:{value:.8},uFresnelPower:{value:.5}},transparent:!0,depthTest:!0,side:ei}),this.geometry=new vs(6,6,e.resolution||512,e.resolution||512),this.rotation.x=Math.PI*.5,this.position.y=0}update(e){this.material.uniforms.uTime.value=e}}const R2=`varying vec2 vUv;

void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}`,C2=`uniform float uTime;
